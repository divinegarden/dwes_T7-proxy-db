        ...
        <form id={formId} action={faction} className="flex flex-col gap-2 border p-4 border-customHG" >
            ...
            {disabled
                ...
                : <details>
                    ...
                    <select className="w-full p-2 border border-customHG rounded-md"
                        name="grupoId"
            ...
            <button
                type="submit"
                className="flex justify-center items-center bg-hoverHG text-white p-2 rounded-md hover:cursor-pointer disabled:bg-customHG disabled:cursor-not-allowed"
                disabled={isPending}
            >
                {isPending
